...

{
	if(x==1)
	{
		image.src='imagenes/tienda/remera3e.jpg';
	}
	else
	if(x==2)
	{
		image.src='imagenes/tienda/remera3f.jpg';
	}
}

function chang (x,image)

{
	if(x==1)
	{
		image.src='imagenes/tienda/buzo1e.jpg';
	}
	else
	if(x==2)
	{
		image.src='imagenes/tienda/buzo1f.jpg';
	}
}
